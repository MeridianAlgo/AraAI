...
class CacheHitRateMonitor:
    ...
    def get_optimization_recommendations(self) -> List[Dict[str, Any]]:
        ...
        with self._lock:
            high_miss_keys = [
                (key, stats) for key, stats in self._key_stats.items()
                if stats['misses'] > 10 and 
                stats['misses'] / (stats['hits'] + stats['misses']) > self.high_miss_rate_threshold
            ]
        ...
        with self._lock:
            ...
            stale_keys = [
                key for key, stats in self._key_stats.items()
            ...
            return {
                ...
                'tasks': {
                    key: {
                        ...
                        'last_warmed': info['last_warmed'].isoformat() if info['last_warmed'] else None,
