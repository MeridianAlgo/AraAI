...
from ara.alerts.notifiers import EmailNotifier, SMSNotifier, WebhookNotifier, BaseNotifier
from ara.core.exceptions import ValidationError, APIError
    ...
    def update_alert(
        ...
        **kwargs
        ...
        with self._lock:
            ...
            allowed_fields = [
                'name', 'condition', 'channels', 'priority', 'status',
                'email_recipients', 'sms_recipients', 'webhook_url',
                'message_template', 'cooldown_minutes', 'metadata'
            ]
