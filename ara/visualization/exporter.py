...
class ChartExporter:
    ...
    def export_to_png(
        ...
        try:
            ...
            print(f"Warning: PNG export failed. Install kaleido: pip install kaleido")
            print(f"Error: {e}")
            return None
    ...
    def export_to_svg(
        ...
        try:
            ...
            print(f"Warning: SVG export failed. Install kaleido: pip install kaleido")
            print(f"Error: {e}")
            return None
    ...
    def export_to_pdf(
        ...
        try:
            ...
            print(f"Warning: PDF export failed. Install kaleido: pip install kaleido")
            print(f"Error: {e}")
            return None
        ...
        if charts:
            ...
            for chart_name, fig in charts.items():
                ...
                if img_path and img_path.exists():
                    # Add chart title
                    story.append(Paragraph(chart_name.replace('_', ' ').title(), 
