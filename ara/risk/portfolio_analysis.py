...
class PortfolioAnalyzer:
    ...
    def plot_risk_contribution(
        ...
        risk_contrib = [risk_decomposition['assets'][asset]['percent_contribution'] for asset in assets]
    ...
    def perform_stress_test(
        ...
        scenario_params = {
            ...
            'Moderate Correction (-10%)': {'return_shock': -0.10, 'vol_multiplier': 1.3},
        ...
        baseline_vol = np.sqrt(np.dot(weight_array, np.dot(cov_matrix, weight_array))) * np.sqrt(252)
    ...
    def plot_portfolio_comparison(
        ...
        for portfolio_name in comparison_df.columns:
            fig.add_trace(go.Bar(
                ...
                text=[f'{v:.2%}' if abs(v) < 10 else f'{v:.2f}' 
